...
urlpatterns = [
    ...
    path("captadores/<int:pk>/eliminar/",views.captador_eliminar,name="captador_eliminar",),
    path("captadores/<int:pk>/editar/", views.captador_editar, name="captador_editar"),
    path("captadores/<int:pk>/convenio/",views.captador_convenio,name="captador_convenio",),
    path("captadores/<int:pk>/comision/",views.captador_configurar_comision,name="captador_configurar_comision",),
    ...
    path( "captaciones/<int:pk>/aprobar/",views.captacion_aprobar,name="captacion_aprobar",),
    path("captaciones/<int:pk>/rechazar/",views.captacion_rechazar,name="captacion_rechazar",),
    path("captaciones/elegibilidad/<int:paciente_id>/",views.elegibilidad_paciente,name="elegibilidad_paciente",),
    path("comisiones/",views.comisiones_panel,name="comisiones_panel",),
    path("comisiones/<int:pk>/",views.comision_detalle,name="comision_detalle",),
    path("liquidaciones/crear/",views.liquidacion_crear,name="liquidacion_crear",),
    path("liquidaciones/",views.liquidaciones_panel,name="liquidaciones_panel",),
